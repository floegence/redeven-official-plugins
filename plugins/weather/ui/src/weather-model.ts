...
const translations = {
  "en-US": {
    ...
    onboardingBody: "Search any place or choose a major city below to see local time, live conditions, and the week ahead.",
    ...
    unavailable: "Live weather is unavailable right now. Your recent locations are still available.",
  ...
  "zh-CN": {
    ...
    onboardingBody: "搜索地点或从下方常用城市中选择，立即查看当地时间、实时天气和未来十天趋势。",
